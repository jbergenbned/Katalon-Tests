...
WebUI.setText(findTestObject('Page_IBM Store Engagement Pack/input_Not Started_pack_shipmentOrderBarcodeScanner'), '00819120')
...
WebUI.executeJavaScript('return document.querySelector("body > print-preview-app").shadowRoot.querySelector("#sidebar").shadowRoot.querySelector("print-preview-button-strip").shadowRoot.querySelector("div > cr-button.cancel-button")', 
    []).click()
