...
WebUI.click(findTestObject('Page_Faber College Bookstore/span_used_digital_rental'))
...
WebUI.click(findTestObject('Page_Checkout  Faber College Bookstore/button_School_Info_Continue_863'))
