...
WebUI.openBrowser(findTestData('Site 680/Order fulfill sites').getValue(1, 11), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_IBM Store Engagement/input_User ID_username'), findTestData('Site 680/Order fulfill sites').getValue(
        3, 11), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Site 235/Page_IBM Store Engagement/input_Password_password'), findTestData('Site 680/Order fulfill sites').getValue(
        4, 11), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Site 235/Page_IBM Store Engagement/input_rental_search_box'), '01052041', FailureHandling.CONTINUE_ON_FAILURE)
