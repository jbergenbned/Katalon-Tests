...
WebUI.click(findTestObject('Page_Checkout  UNH/div_Internal Provider_control__indicator'), FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('Page_Checkout  UNH/input_Student ID Number_primaryProviderStudentId'), findTestData('Site 235/SFA Accounts').getValue(
        1, 4), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Page_Checkout  UNH/button_Apply SFA Funds'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Page_Checkout  UNH/span_Credit  Debit Card'))
...
WebUI.click(findTestObject('Page_Checkout  University of Michigan Campus Bookstore/button_Apply Credit Card'), FailureHandling.OPTIONAL)
