...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('8000 Multi Campus/8009 Levine').getValue(1, 5))
...
WebUI.click(findTestObject('Page_Major Prob. In Afr. Am. History (ll) - With Access  CPCC/span_Digital Purchase_8009'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_Major Prob. In Afr. Am. History (ll) - With Access  CPCC/a_Add to cart_digital purchase 8009'), 
