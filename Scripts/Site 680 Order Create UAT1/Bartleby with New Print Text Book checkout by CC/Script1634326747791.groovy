...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Bartleby').getValue(1, 3), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Search bartleby learn  University of Michigan Campus Bookstore/img'))

WebUI.click(findTestObject('Page_Search bartleby learn  University of Michigan Campus Bookstore/button_I Want Bartleby Add to Cart'))
...
WebUI.click(findTestObject('Page_Endless/span_Print_checkmark'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Page_Checkout  UNH/remove credit card'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Page_Checkout  UNH/button_Saved Payment Methods'))

WebUI.click(findTestObject('Page_Checkout  UNH/span_Use This Payment Method - Copy'))
