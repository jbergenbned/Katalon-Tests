...
WebUI.click(findTestObject('Site 680 objects/Used Print Rental Radio Button'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Checkout  UNH/span_Use This Payment Method_Joe_Discover'), FailureHandling.OPTIONAL)
