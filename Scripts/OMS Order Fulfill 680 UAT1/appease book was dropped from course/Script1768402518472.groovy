...
WebUI.selectOptionByValue(findTestObject('Site 680 objects/select reason code'), '30', false)

WebUI.click(findTestObject('Site 680 objects/select reason code'))

WebUI.click(findTestObject('Site 680 objects/appease amount input box'))

WebUI.clearText(findTestObject('Site 680 objects/appease amount input box'))
