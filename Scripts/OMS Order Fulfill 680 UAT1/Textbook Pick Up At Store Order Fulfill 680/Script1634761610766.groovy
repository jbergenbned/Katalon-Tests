...
WebUI.setText(findTestObject('Site 235/Page_IBM Store Engagement/input_Not Started_pick_shipmentOrderBarcodeScanner'), '01052033')
...
WebUI.click(findTestObject('Site 680 objects/New Print Pickup Label'))
