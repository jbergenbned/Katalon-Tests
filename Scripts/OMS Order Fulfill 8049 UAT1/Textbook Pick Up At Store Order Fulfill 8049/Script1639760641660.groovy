...
WebUI.openBrowser(findTestData('Site 680/Order fulfill sites').getValue(1, 11))
...
WebUI.setText(findTestObject('Site 235/Page_IBM Store Engagement/input_Not Started_pick_shipmentOrderBarcodeScanner'), '01053043')
