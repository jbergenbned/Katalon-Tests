...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 863/863 Data').getValue(1, 2))
...
WebUI.click(findTestObject('Page_Faber College Bookstore/span_used_print'), FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 863/863 Data').getValue(1, 3))
