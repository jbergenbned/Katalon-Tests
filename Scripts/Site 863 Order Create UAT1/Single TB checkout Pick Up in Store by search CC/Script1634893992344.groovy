...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 863/863 Data').getValue(1, 7), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.mouseOver(findTestObject('Page_Apparel, Gifts  Textbooks  UNH/span_0 items'))
...
WebUI.click(findTestObject('Page_Faber College Bookstore/Pickup Info Continue 863'))
