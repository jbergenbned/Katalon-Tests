...
WebUI.navigateToUrl('https://wilkes.uat1.helixbeta.com/', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 502K/502W Data').getValue(1, 15), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('Page_Administration of Programs for Young Children  Wilkes/span_New_Print'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Page_Earthquake Nation  University of Michigan Campus Bookstore/a_Add to cart'), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('Page_Complete Solfeggi for Tuba  UNH/a_Buy again'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Your Shopping Cart  University of Michigan Campus Bookstore/label_Ship to Address'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Checkout  UNH/span_Use This Payment Method_Joe Amex'), FailureHandling.OPTIONAL)
