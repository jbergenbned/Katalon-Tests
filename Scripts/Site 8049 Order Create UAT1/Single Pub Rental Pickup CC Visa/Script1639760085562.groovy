...
WebUI.navigateToUrl('https://spcollege.uat1.helixbeta.com/c/Chemistry-in-Context/p/MBS_2256681_new?currentCampus=8049&currentTerm=8049_4_22_W&currentCourse=8049_4_22_W_15_100_1', 
...
WebUI.click(findTestObject('8049/Rent Only Radio Button'))
...
not_run: WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 680/Site 680 Text Book').getValue(1, 20), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('Page_University of Michigan Campus Bookstore/New Print Rental Radio Button'), FailureHandling.CONTINUE_ON_FAILURE)
