...
WebUI.click(findTestObject('8010 Cato/Page_CPCC/li_Late Fall 2021'))
...
WebUI.scrollToElement(findTestObject('8010 Cato/Page_CPCC/8010 Digital Purchase'), 0)

WebUI.click(findTestObject('8010 Cato/Page_CPCC/Digital Purchase Radio 8010'))

WebUI.click(findTestObject('8010 Cato/Page_CPCC/Digital Add to Cart'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('8010 Cato/Page_CPCC/a_Buy again_Digital Purchase 8010'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('8010 Cato/Page_CPCC/School Information Continue 8010'))
