...
WebUI.setText(findTestObject('Page_Rental Quick App  Home Page/input_Order Number_OrderId'), '00925004')
...
WebUI.click(findTestObject('Page_Rental Quick App  Home Page/Continue'))

not_run: WebUI.click(findTestObject('Page_Rental Quick App  Home Page/button_Complete'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Rental Quick App  Home Page/button_Complete_Payment_Details'), FailureHandling.STOP_ON_FAILURE)
