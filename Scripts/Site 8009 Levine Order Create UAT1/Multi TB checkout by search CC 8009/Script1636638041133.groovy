...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('8000 Multi Campus/8009 Levine').getValue(1, 2), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('8000 Multi Campus/8009 Levine').getValue(1, 3), FailureHandling.CONTINUE_ON_FAILURE)
