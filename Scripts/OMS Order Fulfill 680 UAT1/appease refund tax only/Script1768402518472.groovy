...
WebUI.selectOptionByValue(findTestObject('Site 680 objects/select reason code'), '160', false)

WebUI.click(findTestObject('Site 680 objects/select reason code'))

WebUI.enhancedClick(findTestObject('Site 680 objects/select product tick box for appease'))

WebUI.enhancedClick(findTestObject('Site 680 objects/appease shipping tax tik box'))

WebUI.enhancedClick(findTestObject('Site 680 objects/appease handling fee tax tik box'))
