...
WebUI.setText(findTestObject('Page_Rental Quick App  Home Page/input_Order Number_OrderId'), '00951057')
...
WebUI.click(findTestObject('Page_Rental Quick App  Home Page/Payment Details Complete Button'), FailureHandling.STOP_ON_FAILURE)
