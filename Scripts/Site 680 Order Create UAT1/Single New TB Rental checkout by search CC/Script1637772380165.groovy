...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 680/Site 680 Text Book').getValue(1, 10), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_RAPID ACLS  University of Michigan Campus Bookstore/span_New Print Rental'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Complete Solfeggi for Tuba  UNH/a_view cart (1 item)'), FailureHandling.CONTINUE_ON_FAILURE)
