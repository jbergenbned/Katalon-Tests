...
WebUI.navigateToUrl('https://waketech.uat1.helixbeta.com/')
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 8068/Site 8068 Text Book').getValue(1, 5))
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 8068/Site 8068 Text Book').getValue(1, 6))
