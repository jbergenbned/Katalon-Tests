...
WebUI.setText(findTestObject('Page_IBM Store Engagement/input_Select box clear_returns_ORDER_scanField'), '01045144')
...
WebUI.setText(findTestObject('Page_IBM Store Engagement/input_Exchanges_itemBarCodeTextBox'), '65882')

WebUI.sendKeys(findTestObject('Page_IBM Store Engagement/input_Exchanges_itemBarCodeTextBox'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Page_IBM Store Engagement/button_Add as Exchange'))

WebUI.click(findTestObject('Page_IBM Store Engagement/button_Process Refund'))

WebUI.delay(1)

WebUI.click(findTestObject('Site 680 objects/Finalize Return'))
...
WebUI.click(findTestObject('Site 680 objects/Pay'))
