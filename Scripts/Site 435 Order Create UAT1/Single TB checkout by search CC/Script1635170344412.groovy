...
WebUI.navigateToUrl('https://psu.uat2.helixbeta.com/')
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 435/Site 435 Data').getValue(1, 2), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('Site 435/Payment Method Credit Debit'))

WebUI.click(findTestObject('Page_Checkout  UNH/button_Saved Payment Methods'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Site 435/Use This Payment Method Visa Joe 435'), FailureHandling.OPTIONAL)
