...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Bartleby').getValue(1, 2), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Professional Cooking  UNH/span_Digital Rental'))
...
WebUI.click(findTestObject('Page_Professional Cooking  UNH/button_I Want Bartleby Add to Cart'))
...
WebUI.click(findTestObject('Page_Checkout  UNH/remove credit card'), FailureHandling.OPTIONAL)
