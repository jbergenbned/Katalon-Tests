...
WebUI.click(findTestObject('Page_Faber College Bookstore/span_new_print'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 863/863 Data').getValue(1, 4))
...
WebUI.mouseOver(findTestObject('Page_Apparel, Gifts  Textbooks  UNH/span_Cart 0 items'))
