...
WebUI.sendKeys(findTestObject('chub/action drpdown'), Keys.chord(Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ENTER))

WebUI.click(findTestObject('chub/action go button'))

WebUI.click(findTestObject('chub/autofill button'))

WebUI.click(findTestObject('chub/tracking number field'))

WebUI.setText(findTestObject('chub/tracking number field'), '1Z1F98Y70320711440')

WebUI.click(findTestObject('chub/shipping method'))

WebUI.sendKeys(findTestObject('chub/shipping method'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))
