...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('8000 Multi Campus/8009 Levine').getValue(1, 8))
...
not_run: WebUI.click(findTestObject('Site 680 objects/Rental Books Saved Payment Button'), FailureHandling.OPTIONAL)
