...
WebUI.setText(findTestObject('Page_IBM Store Engagement/input_Select box clear_returns_ORDER_scanField'), '00864044')
...
WebUI.click(findTestObject('Page_IBM Store Engagement/button_Add to Return 1'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_IBM Store Engagement/button_Added_Return_Continue'))

WebUI.click(findTestObject('Page_IBM Store Engagement/button_All_Products_Return_OK'))
