...
WebUI.setText(findTestObject('Page_IBM Store Engagement/input_Select box clear_returns_ORDER_scanField'), '00860225')
...
WebUI.click(findTestObject('Page_IBM Store Engagement/button_Add to Return 1'))
