...
WebUI.openBrowser(findTestData('Site 680/Order fulfill sites').getValue(1, 10))
...
WebUI.setText(findTestObject('Page_IBM Store Engagement/input_Select box clear_returns_ORDER_scanField'), '00874100')
