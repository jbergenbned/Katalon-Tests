...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 502K/502K Data').getValue(1, 3))
...
WebUI.click(findTestObject('Page_Digital Systems Principles and Applications  UNH/span_Digital Purchase'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Page_Checkout  Kings/button_School_Info_Continue'), FailureHandling.OPTIONAL)
