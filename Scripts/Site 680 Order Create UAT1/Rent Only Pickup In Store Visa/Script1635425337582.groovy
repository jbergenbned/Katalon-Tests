...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 680/Site 680 Text Book').getValue(1, 91), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Site 680 objects/rent only radio button'))
...
WebUI.click(findTestObject('Site 680 objects/visa'), FailureHandling.OPTIONAL)
