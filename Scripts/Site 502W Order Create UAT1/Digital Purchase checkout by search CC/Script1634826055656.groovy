...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 502K/502W Data').getValue(1, 4))
...
WebUI.click(findTestObject('Page_Designing Brand Identity  Wilkes/span_Digital Purchase 502W'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Page_Checkout  Wilkes/button_School_Info_502W_Continue'), FailureHandling.OPTIONAL)
