...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('8000 Multi Campus/8000 Central Campus Data').getValue(1, 6), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('8000 Multi Campus/8000 Central Campus Data').getValue(1, 4), FailureHandling.CONTINUE_ON_FAILURE)
