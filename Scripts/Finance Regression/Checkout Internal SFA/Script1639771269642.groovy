...
WebUI.click(findTestObject('Page_Checkout  University of Michigan Campus Bookstore/span_ASCA SFA Only'))

WebUI.click(findTestObject('Page_Checkout  UNH/div_Internal Provider_control__indicator'))

WebUI.setText(findTestObject('Site 680 objects/Student ID Number'), findTestData('Site 235/SFA Accounts').getValue(1, 5))
