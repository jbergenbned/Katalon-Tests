...
WebUI.setText(findTestObject('Page_Apparel, Gifts  Textbooks  University of Michigan Campus Bookstore/input_Enter your search details'), 
    findTestData('Site 680/Site 680 Text Book').getValue(1, 7))
...
WebUI.click(findTestObject('Page_Checkout  University of Michigan FPO/button_Edit'), FailureHandling.OPTIONAL)
